...
public class TestNGAssertionWithReusableMethod {
	public static void main(String[] args) {
		...
		// update place..put http method (declaring placeid as a variable here
		// updating address)
		String newAddress = "Summer walk Us"; // radomly giving any address
												// making newaddress as
												// variable
		...
		JsonPath js2 = files.ReusableMethods.rawToJson(getPlaceResponse);

		String actualAddress = js2.getString("address"); // extracting place
															// address(from
															// response)
